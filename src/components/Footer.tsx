...
export default function Footer() {
  return (
    <footer className="bg-gray-50 border-t border-gray-200" id="main-footer">
      <div className="mx-auto max-w-7xl px-4 py-6 md:py-12">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          {/* Left Section: Links */}
          <div className="flex flex-col items-center md:items-end md:flex-row md:space-x-6 gap-4 md:gap-0" id="footer-links">
            <motion.a
          ...
          <div className="flex flex-col items-center md:items-start" id="footer-social-section">
            <div className="flex space-x-6 gap-4" id="footer-social-links">
              <motion.a
        ...
        {/* AI Disclaimer */}
        <div className="mt-8 pt-4 border-t border-gray-100" id="footer-disclaimer">
